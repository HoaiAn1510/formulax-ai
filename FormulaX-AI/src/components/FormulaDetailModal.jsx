  ...
  return (
    <div className="fixed inset-0 bg-[rgba(15,23,42,0.35)] backdrop-blur-[8px] z-[1000] flex items-end md:items-center justify-center [animation:fadeIn_0.25s_ease-out]" onClick={onClose}>
      ...
      >
        ...
        <button aria-label="Đóng" className="absolute top-4 right-4 bg-[#f1f5f9] hover:bg-[#e2e8f0] dark:bg-[#334155] dark:hover:bg-[#475569] border-none w-9 h-9 rounded-full flex items-center justify-center cursor-pointer text-primary dark:text-[#E2E8F0] transition duration-200" onClick={onClose} title="Đóng">
          <X size={20} />
        </button>
